            ...
            <div class="vczapi-list-zoom-meetings--item__details">
                ...
                <div class="vczapi-list-zoom-meetings--item__details__meta">
                    <div class="hosted-by meta">
                        <strong><?php _e( 'Хоствано от:', 'speed-dating-with-zoom' ); ?></strong>
					...
					if ( vczapi_pro_version_active() && ! empty( $zoom['api']->type ) && vczapi_pro_check_type( $zoom['api']->type ) ) {
						...
						if ( ! empty( $occurence ) ) {
							...
							?>
                            <div class="start-date meta">
                                <strong><?php _e( 'Начална дата', 'speed-dating-with-zoom' ); ?>:</strong>
						...
						?>
                        <div class="start-date meta">
                            <strong><?php _e( 'Type', 'speed-dating-with-zoom' ); ?>:</strong>
						...
						?>
                        <div class="start-date meta">
                            <strong><?php _e( 'Старт', 'speed-dating-with-zoom' ); ?>:</strong>
                            <span><?php echo vczapi_dateConverter( $zoom['api']->start_time, $zoom['api']->timezone, 'F j, Y @ g:i a' ); ?></span>
                        </div>
					<?php } ?>
                    <div class="timezone meta">
                        <strong><?php _e( 'Времева зона', 'speed-dating-with-zoom' ); ?>:</strong> <span><?php echo $zoom['api']->timezone; ?></span>
                    </div>

					<?php do_action( 'vczapi_additional_content_inside_zoom_listing_shortcode' ); ?>
                </div>
                <a href="<?php echo esc_url( get_the_permalink() ) ?>" class="btn vczapi-btn-link"><?php _e( 'Виж събитието', 'speed-dating-with-zoom' ); ?></a>
            </div><!--Details end-->
        </div><!--List item end-->
    </div>
