...
?>
    <div id="vczapi-primary" class="vczapi-primary container">
        ...
        <header class="page-header">
            <h1 class="page-title vczapi-archive-page-title"><?php _e( 'Срещи', 'speed-dating-with-zoom' ); ?></h1>
        </header><!-- .page-header -->
		<?php
		/**
		 * BEFORE LOOP HOOK
		...
		if ( have_posts() ) {
			...
			echo "<p class='vczapi-no-meeting-found'>" . __( 'Няма намерени срещи.', 'speed-dating-with-zoom' ) . "</p>";
		}
