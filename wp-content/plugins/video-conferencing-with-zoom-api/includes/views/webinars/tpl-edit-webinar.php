...
?>
<div class="wrap">
    <h1><?php _e( 'Edit Webinar', 'speed-dating-with-zoom' ); ?></h1>
    <div class="message">
		<?php
    ...
    <form action="" method="POST" class="zvc-meetings-form">
            ...
            <tr>
                ...
                <td>
                    <p class="description" id="option_host_video-description">
                        <input type="checkbox" <?php echo ! empty( $meeting_info->settings->host_video ) ? 'checked' : false; ?> name="option_host_video" value="1" class="regular-text"><?php _e( 'Start video when host join meeting.', 'speed-dating-with-zoom' ); ?>
                    </p>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <p class="description" id="option_panelist_video-description">
                        <input type="checkbox" <?php echo ! empty( $meeting_info->settings->panelists_video ) ? 'checked' : false; ?> name="option_panelist_video" value="1" class="regular-text"><?php _e( 'Start video when panelists join meeting.', 'speed-dating-with-zoom' ); ?>
                    </p>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <p class="description" id="option_hd_video-description">
                        <input type="checkbox" <?php echo ! empty( $meeting_info->settings->hd_video ) ? 'checked' : false; ?> name="option_hd_video" value="1" class="regular-text"><?php _e( 'Defaults to HD video.', 'speed-dating-with-zoom' ); ?>
                    </p>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <select id="option_auto_recording" name="option_auto_recording">
                        <option <?php echo ! empty( $meeting_info->settings->auto_recording ) ? 'selected' : false; ?> value="none"><?php _e( 'No Recordings', 'speed-dating-with-zoom' ); ?>
                        </option>
                        <option <?php echo ! empty( $meeting_info->settings->auto_recording ) ? 'selected' : false; ?> value="local"><?php _e( 'Local', 'speed-dating-with-zoom' ); ?></option>
                        <option <?php echo ! empty( $meeting_info->settings->auto_recording ) ? 'selected' : false; ?> value="cloud"><?php _e( 'Cloud', 'speed-dating-with-zoom' ); ?></option>
                    </select>
        ...
        <p class="submit"><input type="submit" name="create_meeting" class="button button-primary" value="<?php _e( 'Edit Webinar', 'speed-dating-with-zoom' ); ?>"></p>
    </form>
</div>