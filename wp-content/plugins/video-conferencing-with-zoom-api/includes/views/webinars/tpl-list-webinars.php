...
<div class="wrap">
    <h2><?php _e( "Webinars", "speed-dating-with-zoom" ); ?></h2>
    ...
    <div class="select_zvc_user_listings_wrapp">
        <div class="alignleft actions bulkactions">
            ...
            <input type="submit" id="bulk_delete_meeting_listings" data-type="webinar" class="button action" value="<?php _e( "Apply", "speed-dating-with-zoom" ); ?>">
            <a href="<?php echo add_query_arg( array(
				'post_type' => 'zoom-meetings',
				'new'       => 'zoom-video-conferencing-webinars-add'
			) ); ?>" class="button action" title="Add new meeting"><?php _e( 'Add New Webinar', 'speed-dating-with-zoom' ); ?></a>
        </div>
        <div class="alignright">
            <select onchange="location = this.value;" class="zvc-hacking-select">
				...
				) ); ?>"><?php _e( 'Select a User', 'speed-dating-with-zoom' ); ?></option>
    ...
    <div class="zvc_listing_table">
        <table id="zvc_meetings_list_table" class="display" width="100%">
            ...
            <tr>
                ...
                <th class="zvc-text-left"><?php _e( 'Webinar ID', 'speed-dating-with-zoom' ); ?></th>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="row-actionss">
                                <span class="trash"><a style="color:red;" href="javascript:void(0);" data-meetingid="<?php echo $webinar->id; ?>" data-type="webinar" class="submitdelete delete-meeting"><?php _e( 'Trash', 'speed-dating-with-zoom' ); ?></a> | </span>
                                <span class="view"><a href="<?php echo ! empty( $webinar->start_url ) ? $webinar->start_url : $webinar->join_url; ?>" rel="permalink" target="_blank"><?php _e( 'Start via App', 'speed-dating-with-zoom' ); ?></a></span>
                        ...
                        <td>
							...
							if ( $webinar->type === 5 ) {
								...
								_e( 'Recurring Webinar', 'speed-dating-with-zoom' );
							} else {
								echo "N/A";
							}
							?>
