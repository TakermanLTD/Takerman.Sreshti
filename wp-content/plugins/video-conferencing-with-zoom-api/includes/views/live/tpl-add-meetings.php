...
?>
<div class="wrap">
    <h1><?php _e( 'Add a Meeting', 'speed-dating-with-zoom' ); ?></h1>
    <div class="message">
		<?php
    ...
    <a href="edit.php?post_type=zoom-meetings&page=zoom-video-conferencing<?php echo isset( $_GET['host_id'] ) ? '&host_id=' . esc_html( $_GET['host_id'] ) : false; ?>"><?php _e( 'Back to selected host Meetings list', 'speed-dating-with-zoom' ); ?></a>
    ...
    <form action="edit.php?post_type=zoom-meetings&page=zoom-video-conferencing-add-meeting<?php echo isset( $_GET['host_id'] ) ? '&host_id=' . esc_html( $_GET['host_id'] ) : false; ?>" method="POST" class="zvc-meetings-form">
            ...
            <tr>
                ...
                <td>
                    <p class="description" id="join_before_host-description">
                        <input type="checkbox" name="join_before_host" value="1" class="regular-text"><?php _e( 'Join meeting before host start the meeting. Only for scheduled or recurring meetings.', 'speed-dating-with-zoom' ); ?>
                    </p>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <p class="description" id="option_participants_video-description">
                        <input type="checkbox" name="option_participants_video" value="1" class="regular-text"><?php _e( 'Start video when participants join meeting.', 'speed-dating-with-zoom' ); ?>
                    </p>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <p class="description" id="option_mute_participants_upon_entry">
                        <input type="checkbox" name="option_mute_participants" value="1" class="regular-text"><?php _e( 'Mutes Participants when entering the meeting.', 'speed-dating-with-zoom' ); ?>
                    </p>
                </td>
            </tr>
            <tr>
        ...
        <p class="submit"><input type="submit" name="create_meeting" class="button button-primary" value="<?php _e( 'Create Meeting', 'speed-dating-with-zoom' ); ?>"></p>
    </form>
</div>