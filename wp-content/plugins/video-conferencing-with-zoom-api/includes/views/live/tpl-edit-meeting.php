...
?>
<div class="wrap">
    <h1><?php _e( 'Edit a Meeting', 'speed-dating-with-zoom' ); ?></h1>
    <a href="edit.php?post_type=zoom-meetings&page=zoom-video-conferencing&host_id=<?php echo $meeting_info->host_id; ?>"><?php _e( 'Back to List', 'speed-dating-with-zoom' ); ?></a>
    <div class="message">
		<?php
    ...
    <form action="edit.php?post_type=zoom-meetings&page=zoom-video-conferencing-add-meeting&edit=<?php echo esc_html( $_GET['edit'] ); ?>&host_id=<?php echo esc_html( $_GET['host_id'] ); ?>" method="POST" class="zvc-meetings-form">
        ...
        <table class="form-table">
            <tbody>
            <tr>
                <th scope="row"><label for="meetingTopic"><?php _e( 'Meeting Topic *', 'speed-dating-with-zoom' ); ?></label></th>
                <td>
                    ...
                    <p class="description" id="meetingTopic-description"><?php _e( 'Meeting topic. (Required).', 'speed-dating-with-zoom' ); ?></p>
                </td>
            </tr>
            <tr>
                <th scope="row"><label for="meetingAgenda"><?php _e( 'Meeting Agenda', 'speed-dating-with-zoom' ); ?></label></th>
                <td>
                    ...
                    <p class="description" id="meetingTopic-description"><?php _e( 'Meeting Description.', 'speed-dating-with-zoom' ); ?></p>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    ...
                    <p class="description" id="duration-description"><?php _e( 'Meeting duration (minutes). (optional)', 'speed-dating-with-zoom' ); ?></p>
                </td>
            </tr>
            <tr>
                <th scope="row"><label for="password"><?php _e( 'Meeting Password', 'speed-dating-with-zoom' ); ?></label></th>
                <td>
            ...
            <tr>
                ...
                <td>
                    <p class="description" id="join_before_host-description">
                        <input type="checkbox" <?php echo $option_jbh; ?> name="join_before_host" value="1" class="regular-text"><?php _e( 'Join meeting before host start the meeting. Only for scheduled or recurring meetings.', 'speed-dating-with-zoom' ); ?>
                    </p>
                </td>
            </tr>
            <tr>
                <th scope="row"><label for="option_host_video"><?php _e( 'Host join start', 'speed-dating-with-zoom' ); ?></label></th>
                <td>
                    <p class="description" id="option_host_video-description">
                        <input type="checkbox" <?php echo $option_host_video; ?> name="option_host_video" value="1" class="regular-text"><?php _e( 'Start video when host join meeting.', 'speed-dating-with-zoom' ); ?>
                    </p>
                </td>
            </tr>
            <tr>
                <th scope="row">
                    <label for="option_participants_video"><?php _e( 'Participants Video', 'speed-dating-with-zoom' ); ?></label></th>
                <td>
                    <p class="description" id="option_participants_video-description">
                        <input type="checkbox" <?php echo $option_participants_video; ?> name="option_participants_video" value="1" class="regular-text"><?php _e( 'Start video when participants join meeting.', 'speed-dating-with-zoom' ); ?>
                    </p>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <p class="description" id="option_mute_participants_upon_entry">
                        <input type="checkbox" <?php echo $option_mute_participants; ?> value="1" name="option_mute_participants" class="regular-text"><?php _e( 'Mutes Participants when entering the meeting.', 'speed-dating-with-zoom' ); ?>
                    </p>
                </td>
            </tr>
            <tr>
        ...
        <p class="submit"><input type="submit" name="update_meeting" class="button button-primary" value="<?php _e( 'Update Meeting', 'speed-dating-with-zoom' ); ?>"></p>
    </form>
</div>