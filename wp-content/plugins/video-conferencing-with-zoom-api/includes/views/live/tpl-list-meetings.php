...
<div class="wrap">
    <h2><?php _e( "Meetings", "speed-dating-with-zoom" ); ?></h2>
	...
	<?php } else {
        ...
        <div class="select_zvc_user_listings_wrapp">
            <div class="alignleft actions bulkactions">
                <label for="bulk-action-selector-top" class="screen-reader-text"><?php _e( "Select bulk action", "speed-dating-with-zoom" ); ?></label>
                <select name="action" id="bulk-action-selector-top">
                    <option value="trash"><?php _e( "Move to Trash", "speed-dating-with-zoom" ); ?></option>
                </select> <input type="submit" id="bulk_delete_meeting_listings" data-type="meeting" class="button action" value="<?php _e( 'Apply', 'speed-dating-with-zoom' ); ?>">
                <a href="?post_type=zoom-meetings&page=zoom-video-conferencing-add-meeting&host_id=<?php echo esc_html( $get_host_id ); ?>" class="button action" title="Add new meeting"><?php _e( 'Add New Meeting', 'speed-dating-with-zoom' ); ?></a>
            </div>
            <div class="alignright">
                <select onchange="location = this.value;" class="zvc-hacking-select">
                    <option value="?post_type=zoom-meetings&page=zoom-video-conferencing"><?php _e( 'Select a User', 'speed-dating-with-zoom' ); ?></option>
        ...
        <div class="zvc_listing_table">
            <table id="zvc_meetings_list_table" class="display" width="100%">
                ...
                <tr>
                    ...
                    <th class="zvc-text-left"><?php _e( 'Shortcode', 'speed-dating-with-zoom' ); ?></th>
                    <th class="zvc-text-left"><?php _e( 'Topic', 'speed-dating-with-zoom' ); ?></th>
                    <th class="zvc-text-left"><?php _e( 'Status', 'speed-dating-with-zoom' ); ?></th>
                    <th class="zvc-text-left" class="zvc-text-left"><?php _e( 'Start Time', 'speed-dating-with-zoom' ); ?></th>
                    <th class="zvc-text-left"><?php _e( 'Meeting State', 'speed-dating-with-zoom' ); ?></th>
					...
					foreach ( $meetings as $meeting ) {
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <p class="description"><?php _e( 'Click to Copy Shortcode !', 'speed-dating-with-zoom' ); ?></p>
                            </td>
                            <td>
								...
								$start_meeting_via_browser = '<a class="start-meeting-btn reload-meeting-started-button" target="_blank" href="' . esc_url( $zoom_host_url ) . '" class="join-link">' . __( 'Start via Browser', 'speed-dating-with-zoom' ) . '</a>';
								?>
                                <div class="row-actionss">
                                    <span class="trash"><a style="color:red;" href="javascript:void(0);" data-meetingid="<?php echo $meeting->id; ?>" data-type="meeting" class="submitdelete delete-meeting"><?php _e( 'Trash', 'speed-dating-with-zoom' ); ?></a> | </span>
                                    <span class="view"><a href="<?php echo ! empty( $meeting->start_url ) ? $meeting->start_url : $meeting->join_url; ?>" rel="permalink" target="_blank"><?php _e( 'Start via App', 'speed-dating-with-zoom' ); ?></a></span>
                            ...
                            <td>
								...
								if ( $meeting->type === 2 ) {
									...
									_e( 'This is a recurring meeting with no fixed time.', 'speed-dating-with-zoom' );
                            ...
                            <td style="width: 120px;">
								<?php if ( ! isset( $meeting_states[ $meeting->id ]['state'] ) ) { ?>
                                    <a href="javascript:void(0);" class="vczapi-meeting-state-change" data-type="shortcode" data-state="end" data-id="<?php echo $meeting->id ?>"><?php _e( 'Disable Join', 'speed-dating-with-zoom' ); ?></a>
                                    <div class="vczapi-admin-info-tooltip">
                                        <span class="dashicons dashicons-info"></span>
                                        <span class="vczapi-admin-info-tooltip--text"><?php _e( 'Ending this will disable users to join this meeting. Applies to any shortcode output only.', 'speed-dating-with-zoom' ); ?></span>
                                    </div>
								<?php } else { ?>
                                    <a href="javascript:void(0);" class="vczapi-meeting-state-change" data-type="shortcode" data-state="resume" data-id="<?php echo $meeting->id ?>"><?php _e( 'Enable Join', 'speed-dating-with-zoom' ); ?></a>
                                    <div class="vczapi-admin-info-tooltip">
                                        <span class="dashicons dashicons-info "></span>
                                        <span class="vczapi-admin-info-tooltip--text"><?php _e( 'Resuming this will enable users to join this meeting. Applies to any shortcode output only.', 'speed-dating-with-zoom' ); ?></span>
                                    </div>
								<?php } ?>
                            </td>
