...
<div class="zvc-row">
    <div class="zvc-position-floater-left">
        <section class="zoom-api-example-section">
            ...
            <h3><?php _e( 'Using Shortcode Example', 'speed-dating-with-zoom' ); ?></h3>
            <p><?php _e( 'Below are few examples of how you can add shortcodes manually into your posts.', 'speed-dating-with-zoom' ); ?></p>

            <div class="zoom-api-basic-usage">
                <h4>1. <?php _e( 'Basic Usage', 'speed-dating-with-zoom' ); ?>:</h4>
            ...
            <div class="zoom-api-basic-usage" style="margin-top: 20px;border-top:1px solid #ccc;">
                <h4>5. <?php _e( 'Show webinars based on HOST ID in frontend.', 'speed-dating-with-zoom' ); ?>:</h4>
                <code>[zoom_list_host_webinars host="YOUR_HOST_ID"]</code>
            </div>
            <div class="zoom-api-basic-usage" style="margin-top: 20px;border-top:1px solid #ccc;">
                <h4>6. <?php _e( 'Show Webinar based meeting ID.', 'speed-dating-with-zoom' ); ?>:</h4>
                <code>[zoom_api_webinar webinar_id="YOUR_WEBINAR_ID" link_only="no"]</code>
            </div>
            <div class="zoom-api-basic-usage" style="margin-top: 20px;border-top:1px solid #ccc;">
                <h4>7. <?php _e( 'Show recordings based on HOST ID.', 'speed-dating-with-zoom' ); ?>:</h4>
                <code>[zoom_recordings host_id="YOUR_HOST_ID" downloadable="yes"]</code>
            </div>
            <div class="zoom-api-basic-usage" style="margin-top: 20px;border-top:1px solid #ccc;">
                <h4>8. <?php _e( 'Show Recordings based on Meeting ID', 'speed-dating-with-zoom' ); ?>:</h4>
