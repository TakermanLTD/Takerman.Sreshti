...
class Zoom_Video_Conferencing_Admin_Users {
	...
	public static function list_users() {
		...
		if ( isset( $_GET['flush'] ) == true ) {
			...
			self::set_message( 'updated', __( "Flushed User Cache!", "speed-dating-with-zoom" ) );
		}
	...
	public static function add_zoom_users() {
		...
		if ( isset( $_POST['add_zoom_user'] ) ) {
			...
			if ( ! empty( $result->code ) ) {
				...
				self::set_message( 'updated', __( "Created a User. Please check email for confirmation. Added user will only appear in the list after approval.", "speed-dating-with-zoom" ) );
	...
	static function assign_host_id() {
		...
		if ( isset( $_POST['saving_host_id'] ) ) {
			...
			self::set_message( 'updated', __( "Saved !", "speed-dating-with-zoom" ) );
		}
