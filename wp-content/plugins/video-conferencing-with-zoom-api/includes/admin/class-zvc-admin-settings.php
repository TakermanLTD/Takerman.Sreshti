...
class Zoom_Video_Conferencing_Admin_Views {
	...
	public function zoom_video_conference_menus() {
		if ( get_option( 'zoom_api_key' ) && get_option( 'zoom_api_secret' ) && video_conferencing_zoom_api_get_user_transients() ) {
			add_submenu_page( 'edit.php?post_type=zoom-meetings', __( 'Live Webinars', 'speed-dating-with-zoom' ), __( 'Live Webinars', 'speed-dating-with-zoom' ), 'manage_options', 'zoom-video-conferencing-webinars', array(
				'Zoom_Video_Conferencing_Admin_Webinars',
				'list_webinars'
			) );

			add_submenu_page( 'edit.php?post_type=zoom-meetings', __( 'Live Meetings', 'speed-dating-with-zoom' ), __( 'Live Meetings', 'speed-dating-with-zoom' ), 'manage_options', 'zoom-video-conferencing', array(
				'Zoom_Video_Conferencing_Admin_Meetings',
				'list_meetings'
			) );

			add_submenu_page( 'edit.php?post_type=zoom-meetings', __( 'Add Live Meeting', 'speed-dating-with-zoom' ), __( 'Add Live Meeting', 'speed-dating-with-zoom' ), 'manage_options', 'zoom-video-conferencing-add-meeting', array(
				'Zoom_Video_Conferencing_Admin_Meetings',
				'add_meeting'
			) );

			add_submenu_page( 'edit.php?post_type=zoom-meetings', __( 'Zoom Users', 'speed-dating-with-zoom' ), __( 'Zoom Users', 'speed-dating-with-zoom' ), 'manage_options', 'zoom-video-conferencing-list-users', array(
				'Zoom_Video_Conferencing_Admin_Users',
				'list_users'
			) );

			add_submenu_page( 'edit.php?post_type=zoom-meetings', 'Add Users', __( 'Add Users', 'speed-dating-with-zoom' ), 'manage_options', 'zoom-video-conferencing-add-users', array(
				'Zoom_Video_Conferencing_Admin_Users',
				'add_zoom_users'
			) );

			add_submenu_page( 'edit.php?post_type=zoom-meetings', __( 'Reports', 'speed-dating-with-zoom' ), __( 'Reports', 'speed-dating-with-zoom' ), 'manage_options', 'zoom-video-conferencing-reports', array(
				'Zoom_Video_Conferencing_Reports',
				'zoom_reports'
			) );

			add_submenu_page( 'edit.php?post_type=zoom-meetings', __( 'Recordings', 'speed-dating-with-zoom' ), __( 'Recordings', 'speed-dating-with-zoom' ), 'manage_options', 'zoom-video-conferencing-recordings', array(
				'Zoom_Video_Conferencing_Recordings',
				'zoom_recordings'
			) );

			add_submenu_page( 'edit.php?post_type=zoom-meetings', __( 'Extensions', 'speed-dating-with-zoom' ), __( 'Extensions', 'speed-dating-with-zoom' ), 'manage_options', 'zoom-video-conferencing-addons', array(
			...
			if ( defined( 'VIDEO_CONFERENCING_HOST_ASSIGN_PAGE' ) ) {
				add_submenu_page( 'edit.php?post_type=zoom-meetings', __( 'Host to WP Users', 'speed-dating-with-zoom' ), __( 'Host to WP Users', 'speed-dating-with-zoom' ), 'manage_options', 'zoom-video-conferencing-host-id-assign', array(
					'Zoom_Video_Conferencing_Admin_Users',
					'assign_host_id'
				) );
			}

			add_submenu_page( 'edit.php?post_type=zoom-meetings', __( 'Import', 'speed-dating-with-zoom' ), __( 'Import', 'speed-dating-with-zoom' ), 'manage_options', 'zoom-video-conferencing-sync', array(
				'Zoom_Video_Conferencing_Admin_Sync',
				'render'
			) );
		}

		add_submenu_page( 'edit.php?post_type=zoom-meetings', __( 'Settings', 'speed-dating-with-zoom' ), __( 'Settings', 'speed-dating-with-zoom' ), 'manage_options', 'zoom-video-conferencing-settings', array(
			$this,
	...
	public function zoom_video_conference_api_zoom_settings() {
		...
		?>
        <div class="wrap">
            <h1><?php _e( 'Zoom Integration Settings', 'speed-dating-with-zoom' ); ?></h1>
            <h2 class="nav-tab-wrapper">
                <a href="<?php echo add_query_arg( array( 'tab' => 'api-settings' ) ); ?>" class="nav-tab <?php echo ( 'api-settings' === $active_tab ) ? esc_attr( 'nav-tab-active' ) : ''; ?>">
					<?php esc_html_e( 'API Settings', 'speed-dating-with-zoom' ); ?>
                </a>
			...
			if ( 'api-settings' === $active_tab ) {
				if ( isset( $_POST['save_zoom_settings'] ) ) {
                    ...
                    <div id="message" class="notice notice-success is-dismissible">
                        <p><?php _e( 'Successfully Updated. Please refresh this page.', 'speed-dating-with-zoom' ); ?></p>
                        <button type="button" class="notice-dismiss">
                            <span class="screen-reader-text"><?php _e( 'Dismiss this notice.', 'speed-dating-with-zoom' ); ?></span>
                        </button>
                    </div>
					<?php
				}
