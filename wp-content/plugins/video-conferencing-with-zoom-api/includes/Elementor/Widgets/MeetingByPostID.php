...
class MeetingByPostID extends Widget_Base {
	...
	public function get_title() {
		return __( 'Zoom Meeting by Post ID', 'speed-dating-with-zoom' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'section_content',
			[
				'label' => __( 'Select a Zoom Meeting', 'speed-dating-with-zoom' ),
			]
		);
		...
		$this->add_control(
			...
			[
				'name'        => 'post_id',
				'label'       => __( 'Meeting', 'speed-dating-with-zoom' ),
	...
	private function getMeetings() {
		...
		$result[''] = __( 'Select a Meeting', 'speed-dating-with-zoom' );
		if ( ! empty( $meetings ) ) {
