...
class RecordingsByHost extends Widget_Base {
	...
	public function get_title() {
		return __( 'Zoom Recordings by Host', 'speed-dating-with-zoom' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'section_content',
			[
				'label' => __( 'Show Recordings via Host ID', 'speed-dating-with-zoom' ),
			]
		);
		...
		$this->add_control(
			...
			[
				'name'        => 'host_id',
				'label'       => __( 'Select User', 'speed-dating-with-zoom' ),
		...
		$this->add_control(
			...
			[
				'name'        => 'downloadable',
				'label'       => __( 'Show Downloadable Link', 'speed-dating-with-zoom' ),
	...
	protected function render() {
		...
		if ( ! empty( $host_id ) ) {
			...
			_e( 'No user selected.', 'speed-dating-with-zoom' );
		}
	}
