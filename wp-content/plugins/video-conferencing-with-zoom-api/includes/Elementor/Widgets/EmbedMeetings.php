...
class EmbedMeetings extends Widget_Base {
	...
	public function get_title() {
		return __( 'Embed Zoom Meeting', 'speed-dating-with-zoom' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'section_content',
			[
				'label' => __( 'Embed Meeting', 'speed-dating-with-zoom' ),
			]
		);
		...
		$this->add_control(
			'meeting_id',
			[
				'label'       => __( 'Meeting ID', 'speed-dating-with-zoom' ),
		...
		$this->add_control(
			...
			[
				'name'        => 'login_required',
				'label'       => __( 'Requires Login?', 'speed-dating-with-zoom' ),
		...
		$this->add_control(
			...
			[
				'name'        => 'help_text',
				'label'       => __( 'Show Help Text?', 'speed-dating-with-zoom' ),
				'type'        => \Elementor\Controls_Manager::SELECT,
				'label_block' => true,
				'multiple'    => false,
				'options'     => [
		...
		$this->add_control(
			'title_text',
			[
				'label'       => __( 'Title', 'speed-dating-with-zoom' ),
				'type'        => \Elementor\Controls_Manager::TEXT,
				'default'     => __( 'Default title', 'speed-dating-with-zoom' ),
				'placeholder' => __( 'Type your title here', 'speed-dating-with-zoom' ),
			]
		);
		...
		$this->add_control(
			'height',
			[
				'label'       => __( 'Embed Height', 'speed-dating-with-zoom' ),
				'type'        => \Elementor\Controls_Manager::NUMBER,
				'description' => __( 'Put height of the container.', 'speed-dating-with-zoom' ),
				'placeholder' => '500',
				'default'     => 500
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'label'       => __( 'Disable Countdown Timer?', 'speed-dating-with-zoom' ),
				'type'        => \Elementor\Controls_Manager::SELECT,
				'label_block' => true,
				'multiple'    => false,
				'options'     => [
		...
		$this->add_control(
			'passcode',
			[
				'label'       => __( 'Meeting Password', 'speed-dating-with-zoom' ),
				'type'        => \Elementor\Controls_Manager::TEXT,
				'placeholder' => __( 'Meeting Password', 'speed-dating-with-zoom' ),
			]
		);
		...
		$this->add_control(
			...
			[
				'name'        => 'enable_webinar',
				'label'       => __( 'Webinar ?', 'speed-dating-with-zoom' ),
				'type'        => \Elementor\Controls_Manager::SELECT,
				'label_block' => true,
				'multiple'    => false,
				'options'     => [
	...
	protected function render() {
		...
		if ( ! empty( $meeting_id ) ) {
			...
			_e( 'No Meeting ID is defined.', 'speed-dating-with-zoom' );
		}
	}
