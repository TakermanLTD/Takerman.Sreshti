...
class MeetingList extends Widget_Base {
	...
	public function get_title() {
		return __( 'Zoom Meetings List', 'speed-dating-with-zoom' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'section_content',
			[
				'label' => __( 'Content', 'speed-dating-with-zoom' ),
			]
		);
		...
		$this->add_control(
			...
			[
				'name'        => 'Author ID',
				'label'       => __( 'Author ID', 'speed-dating-with-zoom' ),
				'type'        => \Elementor\Controls_Manager::NUMBER,
				'label_block' => true,
				'description' => __( 'Show meeting posts based on Author ID', 'speed-dating-with-zoom' )
			]
		);
		...
		$this->add_control(
			...
			[
				'name'        => 'category',
				'label'       => __( 'Meetings Category', 'speed-dating-with-zoom' ),
		...
		$this->add_control(
			...
			[
				'name'        => 'order',
				'label'       => __( 'Meetings Order By', 'speed-dating-with-zoom' ),
		...
		$this->add_control(
			...
			[
				'name'        => 'type',
				'label'       => __( 'Meetings Type', 'speed-dating-with-zoom' ),
				'type'        => \Elementor\Controls_Manager::SELECT,
				'label_block' => true,
				'options'     => [
					''         => 'Show All',
		...
		$this->add_control(
			...
			[
				'name'        => 'filter',
				'label'       => __( 'Show Filter', 'speed-dating-with-zoom' ),
				'type'        => \Elementor\Controls_Manager::SELECT,
				'label_block' => true,
				'options'     => [
					'yes' => 'Yes',
		...
		$this->add_control(
			...
			[
				'name'        => 'count',
				'label'       => __( 'Count of meetings', 'speed-dating-with-zoom' ),
				'type'        => \Elementor\Controls_Manager::NUMBER,
				'label_block' => true,
				'default'     => 3
			]
		...
		$this->add_control(
			...
			[
				'name'        => 'show_on_past',
				'label'       => __( 'Meeting Display Threshold', 'speed-dating-with-zoom' ),
				'type'        => \Elementor\Controls_Manager::SELECT,
				'label_block' => true,
				'options'     => [
					'yes' => 'Yes',
				...
				'default'     => 'yes',
				'description' => __( 'Setting this to yes will display meetings for 30 minutes more after the meeting date has passed. This will only work if Meeting Type is defined.', 'speed-dating-with-zoom' )
			]
		);
		...
		$this->add_control(
			...
			[
				'name'        => 'cols',
				'label'       => __( 'Column Layout', 'speed-dating-with-zoom' ),
				'type'        => \Elementor\Controls_Manager::SELECT,
				'label_block' => true,
				'options'     => [
					1 => '1 column layout',
