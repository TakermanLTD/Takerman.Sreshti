...
class WebinarList extends Widget_Base {
	...
	public function get_title() {
		return __( 'Zoom Webinars List', 'speed-dating-with-zoom' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				'name'        => 'category',
				'label'       => __( 'Webinars Category', 'speed-dating-with-zoom' ),
		...
		$this->add_control(
			...
			[
				'name'        => 'order',
				'label'       => __( 'Webinars Order By', 'speed-dating-with-zoom' ),
		...
		$this->add_control(
			...
			[
				'name'        => 'type',
				'label'       => __( 'Webinars Type', 'speed-dating-with-zoom' ),
				'type'        => \Elementor\Controls_Manager::SELECT,
				'label_block' => true,
				'options'     => [
					''         => 'Show All',
		...
		$this->add_control(
			...
			[
				'name'        => 'count',
				'label'       => __( 'Count of Webinars', 'speed-dating-with-zoom' ),
				'type'        => \Elementor\Controls_Manager::NUMBER,
				'label_block' => true,
				'default'     => 3
			]
		...
		$this->add_control(
			...
			[
				'name'        => 'show_on_past',
				'label'       => __( 'Webinar Display Threshold', 'speed-dating-with-zoom' ),
				'type'        => \Elementor\Controls_Manager::SELECT,
				'label_block' => true,
				'options'     => [
					'yes' => 'Yes',
