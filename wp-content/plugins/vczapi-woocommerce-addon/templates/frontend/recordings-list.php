<a href="javascript:void(0);" class="vczapi-woocommerce-clear-recordings-cache"><?php _e( 'Fetch New Recordings', 'vczapi-woocommerce-addon' ); ?></a>
<div class="vczapi-my-accounts-purchased-recordings">
    <h3><?php _e( 'Recordings for Purchased Meetings', 'vczapi-woocommerce-addon' ); ?></h3>
    <table class="vczapi-woocommerce-recordings-datatable responsive nowrap">
        <thead>
        <tr>
