...
= 1.9.10.41 =
* Fixed messages deleting did not reduce messages counter in ajax version

= 1.9.10.40 =
* Fixed avatars were not displayed in some cases when using with PeepSo

= 1.9.10.39 =
* Fixed youzify icons conflict
* Fixed youzify call buttons in the profile
* Clean thread meta on new thread creation to avoid issue when DB is incostistent
* Other bugfixes and improvements

= 1.9.10.37 =
* Fixed possible conflict with avatars in PeepSo

= 1.9.10.36 =
* Fixed minor backend logic issues

= 1.9.10.35 =
* Improved find existing threads SQL query
* Added dev hooks by request
* Other bugfixes and improvements
* Tested up to 6.0
...
= 1.9.10.32 =
* CSS Fix for BB Icons

= 1.9.10.31 =
* CSS fix to avoid zoom when clicking textarea on iOS
* CSS fix for conflict with WCFM and BuddyBoss

= 1.9.10.30 =
* CSS fix for positioning of favorite button

= 1.9.10.29 =
* Fixed name was not displayed in some cases
* Improved CSS to avoid conflicts with custom checkboxes CSS

= 1.9.10.28 =
* Fixed robotic sound in new versions of Firefox browser

= 1.9.10.27 =
* Added WPML hooks to Email Notifications sender (plugin now should send email in user preffered language when using with WPML)
* Fixed message editing in mobile version
