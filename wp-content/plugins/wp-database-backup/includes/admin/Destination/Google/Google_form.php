...
if (isset($_POST['wpdb_google_drive']) && $_POST['wpdb_google_drive'] == 'Y') {
    ...
    if (isset($_POST['Save']) && $_POST['Save'] == 'Save') {
        ...
        update_option('wpdb_dest_google_client_key', esc_attr($clientId));
        update_option('wpdb_dest_google_secret_key', esc_attr($clientSecret));
        ...
        if (isset($_GET['code'])) {
            update_option('wpdb_dest_google_authCode', esc_attr($_GET['code']));
        } else {
